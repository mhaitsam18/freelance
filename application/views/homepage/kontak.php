            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="<?= base_url('Auth/home') ?>">Home</a></li>
                            <li><a href="<?= base_url('Auth/jobs') ?>">Jobs</a></li>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">About</a>

                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?= base_url('Auth/about') ?>">About Us</a>
                                    <a class="dropdown-item" href="<?= base_url('Auth/team') ?>">Team</a>
            ...
            <div class="row text-center">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="<?= base_url() ?>assets/images/line-dec.png" alt="waves">
    ...
    <section class="section" id="contact-us" style="margin-top: 0">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="contact-form section-bg" style="background-image: url(<?= base_url() ?>assets/images/contact-1-720x480.jpg)">
