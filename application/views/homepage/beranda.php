...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="<?= base_url('Auth/home') ?>" class="logo">Job Agency<em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="<?= base_url('Auth/home') ?>" class="active">Home</a></li>
                            <li><a href="<?= base_url('Auth/jobs') ?>">Lowongan</a></li>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Tentang</a>

                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?= base_url('Auth/about') ?>">Tentang Kami</a>
                                    <a class="dropdown-item" href="<?= base_url('Auth/team') ?>">Tim</a>
                            ...
                            <li><a href="<?= base_url('Auth/kontak') ?>">Daftar</a></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="<?= base_url('') ?>assets/images/line-dec.png" alt="">
    ...
    <section class="section section-bg" id="schedule" style="background-image: url(<?= base_url('') ?>assets/images/about-fullscreen-1-1920x700.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
