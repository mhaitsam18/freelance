		                    ...
		                    <div class="row no-gutters">
		                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-3 col-3">
		                            ...
		                            <div class="users-container">
		                            	<form action="<?= base_url('Freelance/chat/') ?>" method="get">
		                                ...
		                                <ul class="users" style="height: 500px; overflow: auto; width: 100%;">
		                                	<?php foreach ($chat as $c): ?>
			                                    <li class="person" data-chat="person1" onclick="cariChat(<?= $c->id_user ?>)">
			                                        <div class="user">
			                                            <img src="<?= base_url('assets/img/profil/'.$c->image) ?>" alt="Retail Admin">
			                                            <?php 
			                                        ...
			                                        <p class="name-time">
			                                            <span class="name"><?= $c->nama_perusahaan ?></span>
				...
				<?php foreach ($perusahaan as $p): ?>
					<ul class="users">
						<li class="person" onclick="cariChat(<?= $p['idu'] ?>)" data-dismiss="modal">
							...
							<span class="text-muted"><?= $p['nama_perusahaan'] ?></span>
						</li>
					</ul>
					<hr>
				<?php endforeach ?>
