<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form action="<?= base_url('Freelance/editpass'); ?>" method="post">
                <div class="form-group">
                    <label for="current_password">Password</label>
                    <input type="password" class="form-control" id="current_password" name="current_password"><?= form_error('current_password', '<small class= "text-danger pl-3">', '</small>'); ?>
